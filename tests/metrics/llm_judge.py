...
class LLMJudgeMetric(MetricBase):
    ...
    def _build_grading_prompt(self, question: str, expected: str, answer: str) -> str:
...
- Be fair but rigorous in your assessment"""
    ...
    def calculate(self, answer: str, expected: str, keywords: Optional[List[str]] = None, question: Optional[str] = None) -> float:
        ...
        # Fallback if question isn't passed
        if not question:
            question = "Evaluate this answer"
        
        try:
            prompt = self._build_grading_prompt(question, expected, answer)
...
def get_score(question: str, answer: str, use_structured_output: bool = True) -> Optional[float]:
    ...
    return judge.calculate(answer=answer, expected="", question=question)
